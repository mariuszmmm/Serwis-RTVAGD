...
export const getDataForMetaTags = async (key) => {
  ...
  const dataForMetaTags = {
    ...
    naprawa_ekspresow: {
      metaTags: {
        title: `Naprawa Ekspresów do Kawy Przemyśl ☎️ ${formattedPhoneNumber} | Serwis AGD`,
        ogTitle: `Naprawa Ekspresów do Kawy Przemyśl ☎️ ${formattedPhoneNumber} | Serwis AGD`,
        twitterTitle: `Naprawa Ekspresów do Kawy Przemyśl ☎️ ${formattedPhoneNumber} | Serwis AGD`,
      ...
      schema: {
        ...
        imageObject: {
          ...
          width: 700,
          height: 700,
          name: `Naprawa Ekspresów do Kawy Przemyśl ☎️ ${formattedPhoneNumber} | Serwis AGD`,
