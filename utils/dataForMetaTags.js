  ...
  const dataForMetaTags = {
    home: {
      metaTags: {
        ...
        title: `Serwis RTV i AGD ☎️ ${formattedPhoneNumber} | ${shortName}`,
        ogTitle: `Serwis RTV i AGD ☎️ ${formattedPhoneNumber} | ${shortName}`,
        twitterTitle: `Serwis RTV i AGD ☎️ ${formattedPhoneNumber} | ${shortName}`,
      ...
      schema: {
        ...
        webpage: {
          ...
          url: appUrls.home,
          inLanguage: "pl-PL",
          name: `Serwis RTV i AGD ☎️ ${formattedPhoneNumber} | ${shortName}`,
