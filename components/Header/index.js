import { HeaderContainer, HeaderWrapper, ListItem, Logo, NavList, StyledLink } from "./styled";
...
const Header = (props) => {
  ...
  return (
    ...
    >
      <HeaderContainer>
        <Logo href={appUrls.home} title={`${serwis.subName}`}>
          <Emoticon $logo>
            <Image
              src={imageUrls.logo}
        ...
        <nav>
          <NavList>
            <ListItem>
              <StyledLink href={appUrls.home} $active={pathname === "/"}>
                Strona Główna
              </StyledLink>
            </ListItem>
            <ListItem>
              <StyledLink href={appUrls.o_mnie} $active={pathname === "/o-mnie/"}>
                O mnie
              </StyledLink>
            </ListItem>
            <ListItem
            ...
            >
              <StyledLink as='div' $active={servicesPath && !showSubNav} $disabled>
                Usługi
              </StyledLink>
              <SubNav showSubNav={showSubNav} />
            </ListItem>
            <ListItem>
              <StyledLink href={appUrls.opinie} $active={pathname === "/opinie/"}>
                Opinie
              </StyledLink>
            </ListItem>
            <ListItem>
              <StyledLink href={appUrls.kontakt} $active={pathname === "/kontakt/"}>
                Kontakt
              </StyledLink>
            </ListItem>
          </NavList>
